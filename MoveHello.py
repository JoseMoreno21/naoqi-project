...
Speech = ALProxy("ALTextToSpeech","127.0.0.1",9559)
...
def main():
    Speech.say("Hola, soy el robot Nao")
    time.sleep(2)
    Speech.say("Mi funcion es informarte sobre las posibles enfermedades que puedas padecer; pero no te alarmes. Yo no diagnostico.")
    time.sleep(2)
    Speech.say("Cual es tu nombre")
    nombre = raw_input("Cual es tu nombre?\n")
    time.sleep(2)
    Speech.say("Hola " + nombre)
    time.sleep(2)
    Speech.say("Cuantos anios tienes")
    ...
    Mi_Edad = int(Mi_Edad)
    time.sleep(2)
    Speech.say("Entiendo, tienes " + str(Mi_Edad) + " anio(s)")
    time.sleep(2)
    Speech.say("Cual es tu sexo")
    ...
    time.sleep(2)
    if(Mi_Sexo):
        Speech.say("Ya veo, eres un hombre")
    else:
        Speech.say("Ya veo, eres una mujer")
    time.sleep(2)

    Speech.say("Ahora te voy a mostrar una lista de sintomas")
    time.sleep(2)
    Speech.say("Quiero que me digas cuales de ellos tienes segun su indice")
    time.sleep(2)
    Speech.say("Cuando hayas colocado todos tus sintomas, ingresa 0")
    time.sleep(5)
    ...
    while(aux != 0):
        ...
        if(aux > 0):
            ...
            time.sleep(2)
            Speech.say("Entiendo, tienes el sintoma " + Lista_Sintomas[aux-1])
            time.sleep(2)
            ...
            if(grav == 0):
                ...
                if(grav == 1):
                    time.sleep(2)
                    Speech.say("Entiendo, el sintoma es medio")
                    Mi_Gravedad.append("medio")
                else:
                    time.sleep(2)
                    Speech.say("Entiendo, el sintoma es alto")
                    Mi_Gravedad.append("alto")
            aux = -1
            time.sleep(2)
            Speech.say("Ok, continua")
            print("Ok, continua...")
    time.sleep(3)
    Speech.say("Listo, esos serian todos tus sintomas\n")
    time.sleep(2)
    print("--- PROCESANDO ---")
    print("")
    time.sleep(3)
    algoritmo(Mi_Edad,Mi_Sexo)
    print("")
    if(len(Mis_Sintomas) != 0):
        time.sleep(2)
